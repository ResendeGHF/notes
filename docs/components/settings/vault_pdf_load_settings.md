# `lib/components/settings/vault_pdf_load_settings.dart`
...
Collapsible settings for vault PDF loading mode.
 Allows choosing RAM-only (secure, slower) vs temp file (faster, secure-deleted).
