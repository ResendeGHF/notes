...
abstract class SaberQuillStyles {
  static DefaultStyles get({
    ...
    final _ArgRecord args = (
      ...
      fontFamily: appBodyTextStyle?.fontFamily,
    );
    if (_lastArgs == args) {
    ...
    return _cachedStyles = _createStyles(
      ...
      secondary: secondary,
      lineHeight: lineHeight,
      appBodyTextStyle: appBodyTextStyle,
    );
  }
  ...
  static DefaultStyles _createStyles({
    ...
    final baseStyle = TextStyle(
      inherit: false,
      fontFamily: appBodyTextStyle?.fontFamily ?? 'Roboto',
      fontFamilyFallback:
          appBodyTextStyle?.fontFamilyFallback ?? saberSansSerifFontFallbacks,
