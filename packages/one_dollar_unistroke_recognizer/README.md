**Local fork for Saber** — This package is vendored here so we can extend it with custom shape-recognition algorithms. Upstream: [one_dollar_unistroke_recognizer](https://github.com/adil192/one_dollar_unistroke_recognizer).
