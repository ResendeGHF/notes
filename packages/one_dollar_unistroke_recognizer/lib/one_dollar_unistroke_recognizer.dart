...
export 'package:one_dollar_unistroke_recognizer/src/line_detection.dart'
    show fitLineAndProjectExtent, meanAbsoluteError;
export 'package:one_dollar_unistroke_recognizer/src/shape_discriminators.dart'
    show computeRoundness, isAngleBracketPreferred, isBracePreferred, isBracketPreferred;
...
RecognizedCustomUnistroke<K>? recognizeCustomUnistroke<K>(
  ...
  // Need at least 2 points; recognizer will resample to numPoints internally
